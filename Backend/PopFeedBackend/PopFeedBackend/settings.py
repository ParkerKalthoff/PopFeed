"""
Django settings for PopFeedBackend project.
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # shomorpwopwopw
...
ROOT_URLCONF = 'PopFeedBackend.urls'
...
WSGI_APPLICATION = 'PopFeedBackend.wsgi.application'
